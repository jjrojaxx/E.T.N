...
<template>
        ...
        <div class="max-w-screen px-4 px mx-auto">
            <div class="flex flex-col items-center mb-4">
                <h1 class="text-center mb-4 text-3xl font-bold md:text-5xl lg:text-6xl gradient-text">Impulsa el
                    futuro digital con <br> la Administración</h1>
    ...
    <section class="bg-gray-950">
        <div
            ...
            <div class="mt-4 md:mt-0">
                <h2 class="mb-4 text-3xl lg:text-5xl tracking-tight font-bold text-gray-900 dark:text-white">¿Que es la  Administración?
                </h2>
                <p class="mb-6 font-normal text-gray-500 md:text-lg">La administración es una ciencia social que estudia cómo planificar, organizar, dirigir y controlar los recursos humanos, 
                     financieros y materiales en organizaciones
                     humanas, con el fin de alcanzar objetivos específicos y obtener el mayor beneficio posible.</p>           
            </div>
        </div>
    </section>
    ...
    <section class="bg-blue-100">
        <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid-cols-2 sm:py-16 lg:px-6">
            <h2 class="mb-8 text-3xl lg:text-5xl tracking-tight font-bold text-gray-950 text-center">Objetivos de la Administración
            </h2>
            <div class="flex gap-4 flex-wrap justify-center">
                <div class="border border-gray-200 rounded-lg shadow-sm bg-gray-50 p-4 flex flex-col items-center w-full md:w-1/3 lg:w-1/4">
                    ...
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-center text-[#150484]">Planificación</h5>
                    <p class="font-normal text-gray-800 text-center">Diseñar la mejor manera de alcanzar los objetivos futuros.</p>
                </div>
                <div class="border border-gray-200 rounded-lg shadow-sm bg-gray-50 p-4 flex flex-col items-center w-full md:w-1/3 lg:w-1/4">
                    <svg class="size-16 text-[#150484]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="none" viewBox="0 0 24 24">
                    ...
                    <h5 class="mb-2 text-2xl font-bold tracking-tight  text-[#150484] text-center">Organización
                    </h5>
                    <p class="font-normal text-gray-800 text-center">Coordinar recursos y actividades para un trabajo eficiente.</p>
                </div>
                <div class="border border-gray-200 rounded-lg shadow-sm bg-gray-50 p-4 flex flex-col items-center w-full md:w-1/3 lg:w-1/4">
                    <svg class="size-16 text-[#150484]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-center text-[#150484]">Dirección</h5>
                    <p class="font-normal text-gray-800 text-center">Liderar y motivar al equipo para cumplir metas.</p>
                </div>
                 ...
                 <div class="border border-gray-200 rounded-lg shadow-sm bg-gray-50 p-4 flex flex-col items-center w-full md:w-1/3 lg:w-1/4">
                    ...
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-center text-[#150484]">Control</h5>
                    <p class="font-normal text-gray-800 text-center">Evaluar el desempeño y ajustar estrategias para mejorar resultados.</p>
                </div>
    ...
    <section class="bg-blue-100">
        <div class="gap-8 items-center flex-col sm:flex-row py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:flex md:grid-cols-2 sm:py-16 lg:px-6">
            <div class="mt-4 md:mt-0 w-full">
                <h2 class="mb-4 text-3xl lg:text-5xl tracking-tight font-bold text-gray-900 ">Origen e historia de la Administración
                </h2>
    ...
    <section class="bg-blue-100">
        <div class="gap-8 items-start flex flex-col-reverse sm:flex-row py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:flex md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div class="mt-4 md:mt-0 w-full">
                <h2 class="mb-4 text-3xl lg:text-5xl tracking-tight font-bold text-gray-900 ">Importancia de la Administración</h2>
                <ul>
                    <li class="mb-1 font-normal text-gray-900 md:text-lg flex items-center">
                        ...
                        <strong>Planificación: Definir objetivos y diseñar estrategias para alcanzar las metas organizacionales.</strong>
                    </li>
                    <li class="mb-1 font-normal text-gray-900 md:text-lg flex items-center">
                        <svg class="size-6 text-blue-500 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <li class="mb-1 font-normal text-gray-900 md:text-lg flex items-center">
                        ...
                        <strong>Dirección: Liderar y motivar al equipo para lograr un desempeño eficiente.</strong>
                    </li>
                    <li class="mb-1 font-normal text-gray-900 md:text-lg flex items-center">
                        ...
                        <strong>Control: Supervisar y evaluar los resultados para asegurar el cumplimiento de los objetivos.</strong>
                    </li>
    ...
    <section class="bg-blue-100">
        ...
        <div class="gap-8 items-start py-8 px-4 mx-auto max-w-screen-xl  ">
            ...
            <div>
                ...
                <p><strong>Estudiar Administración te prepara para gestionar recursos humanos, financieros y materiales de manera eficiente en cualquier tipo de organización. Esta carrera ofrece habilidades clave para la toma de decisiones, liderazgo y resolución de problemas, fundamentales en un mundo empresarial competitivo. Además, abre un amplio abanico de oportunidades laborales en diferentes sectores, desde empresas privadas hasta organismos públicos, permitiéndote contribuir al éxito y crecimiento de las organizaciones.</strong></p>
